 ...
 -->
    ...
    <f7-panel right cover layout="dark">
      <f7-view id="right-panel-view" navbar-through :dynamic-navbar="true">
        <f7-navbar title="תפריט" sliding></f7-navbar>
        <f7-pages>
          <f7-page>
            <!-- <f7-block>
    ...
    <f7-views>
      <f7-view id="main-view" navbar-through :dynamic-navbar="true" main>
        ...
        <f7-navbar>
          ...
          <f7-nav-center sliding>מילים ומושגים</f7-nav-center>

        </f7-navbar>
        <!-- Pages -->
        <f7-pages>
          <f7-page>
            <f7-block-title>המילון העיברי החדש</f7-block-title>
            <f7-block inner>
              <p>מושגים ומילים שאני נוטה להשתמש בהם</p>
            </f7-block>
            <f7-block-title>מילים מובילות</f7-block-title>
            <f7-list>
              <f7-list-item  title="פלופ"></f7-list-item>
              <f7-list-item  title="סלזמן"></f7-list-item>
              <f7-list-item  title="חולניק"></f7-list-item>
            </f7-list>
